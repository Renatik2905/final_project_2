...
# Создаём таблицу с администраторами
cursor.execute('''
...
data = [
    ...
    ("Понедельник", 7, "13:30-14:15", "Физкультура", "Смирнов А.А."),  # Добавляем 7-й урок
    ...
    ("Среда", 7, "13:30-14:15", "Физкультура", "Смирнов А.А."),  # Добавляем 7-й урок
    ...
    ("Четверг", 7, "13:30-14:15", "Физкультура", "Смирнов А.А."),  # Добавляем 7-й урок
...
# Добавляем администраторов (пример)
admins = [123456789, 987654321, 6886765529]  # Добавьте сюда ID ваших администраторов
